# Database Schema - MVP Multi-Step Form

## Overview

This document describes the database schema designed to support the multi-step landing page form and MVP business model.

### Features

The schema provides comprehensive support for:
...
**Option 1: Using initialization scripts (recommended):**
...
### For Existing Databases (Upgrading from V1)
...
- `database/schema.sql` - PostgreSQL full schema
- `database/schema_mysql.sql` - MySQL full schema
- `database/migrations/001_v1_to_v2_migration.sql` - PostgreSQL migration from V1
- `database/migrations/001_v1_to_v2_migration_mysql.sql` - MySQL migration from V1
- `database/README.md` - This documentation
- `database/init_db.py` - PostgreSQL initialization script
- `database/init_db_mysql.py` - MySQL initialization script
